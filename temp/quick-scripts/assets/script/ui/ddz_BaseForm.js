(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/ddz_BaseForm.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddz0ca7b-38cb-467f-b2b8-9e156008281f', 'ddz_BaseForm', __filename);
// script/ui/ddz_BaseForm.js
...
var ddz_BaseForm = cc.Class({
  ...
  */
	...
	SetNodeImageByFilePath: function SetNodeImageByFilePath(node, filePath) {
		...
		var that = this;
		return app.ddz_ControlManager().CreateLoadPromise(filePath, cc.SpriteFrame).then(function (spriteFrame) {
			if (!spriteFrame) {
	...
	SetWndImageByFilePath: function SetWndImageByFilePath(wndPath, filePath) {
		...
		return app.ddz_ControlManager().CreateLoadPromise(filePath, resType).then(function (spriteFrame) {
  ...
  */
	...
	SuccessTcnUrl: function SuccessTcnUrl(serverPack) {
		var shareUrl = "https://www.qp355.com/" + app.ddz_ComTool().GetPid(app.ddz_HeroManager().GetHeroProperty("pid")) + "/";
		if (this.TuiGuangUrl) {
			text = this.ShareText + "\n" + "下载地址:" + shareUrl;
		} else {
			if (url_short) {
	...
	Click_btn_weixin: function Click_btn_weixin() {
		var share = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
	...
	WanFa: function WanFa() {
		...
		var sportsDouble = room.GetRoomConfigByProperty("sportsDouble");
		if (cfg != null) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_BaseForm.js.map
