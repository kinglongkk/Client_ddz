(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/ddz_UIMessage02.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '99248Y84I1O05U1cScrs2lW', 'ddz_UIMessage02', __filename);
// script/ui/ddz_UIMessage02.js
...
cc.Class({
    ...
    OnShow: function OnShow() {
        ...
        var timeString = app.ddz_ServerTimeManager().GetCDTimeStringBySec(this.endSec, this.ShareDefine.ShowSecondSec);
    ...
    OnClick: function OnClick(btnName, btnNode) {
        ...
        if (btnName == "btnCancel") {
            ...
            app.ddz_GameManager().SendDissolveRoomRefuse(roomID);
            this.Show_btnCancel_btnSure(false);
        } else if (btnName == "btnSure") {
            //this.RoomMgr.SendDissolveRoomAgree(roomID);
            app.ddz_GameManager().SendDissolveRoomAgree(roomID);
            this.Show_btnCancel_btnSure(false);
        }
    }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_UIMessage02.js.map
