(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ui/ddz_FormManager.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddzjf424-5aa1-461e-8950-77b92961c5d5', 'ddz_FormManager', __filename);
// script/ui/ddz_FormManager.js
...
var ddz_FormManager = app.BaseClass.extend({

    //初始化
    Init: function Init() {
        this.JS_Name = app["subGameName"] + "_FormManager";

        var SysDataManager = app.ddz_SysDataManager();
    ...
    CreateForm: function CreateForm(formPath) {
        ...
        //     promise = app.ddz_ControlManager().CreateLoadPromise(formPath);
        // }

        var that = this;
        return app.ddz_ControlManager().CreateLoadPromise(formPath).then(function (prefab) {
    ...
    LoadSceneDefaultForm: function LoadSceneDefaultForm(sceneName) {
        ...
        var NoAddScene = ['clubScene', 'fightScene', 'launchScene', 'loginScene', 'ddzMainScene']; //四个基础场景不用添加uimore，uimark
        var BaseForm = [];
        if (this.isInArray(sceneName, NoAddScene) == false) {
            ...
            //3D切换
            var is3DShow = app.LocalDataManager().GetConfigProperty("SysSetting", app.subGameName + "_is3DShow");
            if (is3DShow == 0 && GamePrefab == "game/" + app.subGameName.toUpperCase() + "/UI" + app.subGameName.toUpperCase() + "_Play") {
                //2D场景需要切换
                GamePrefab = "game/" + app.subGameName.toUpperCase() + "/UI" + app.subGameName.toUpperCase() + "_2DPlay";
            }
            if (is3DShow == 1 && GamePrefab == "game/" + app.subGameName.toUpperCase() + "/UI" + app.subGameName.toUpperCase() + "_2DPlay") {
                //2D场景需要切换
                GamePrefab = "game/" + app.subGameName.toUpperCase() + "/UI" + app.subGameName.toUpperCase() + "_Play";
            }
...
var g_ddz_FormManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function () {
    if (!g_ddz_FormManager) {
        g_ddz_FormManager = new ddz_FormManager();
    }
    return g_ddz_FormManager;
};
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_FormManager.js.map
