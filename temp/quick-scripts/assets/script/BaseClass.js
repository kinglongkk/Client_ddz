(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/BaseClass.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddzj1fa8-dffb-4b7c-9c42-c9128ac67ec8', 'BaseClass', __filename);
// script/BaseClass.js
...
/*
    客户端自定义基类
*/
var ShareDefine = require("ddz_ShareDefine").GetModel();
...
var DBBaseClass = BaseClass.extend({
	...
	LoadInitDB: function LoadInitDB(headName, sendPack) {
		...
		//发送请求初始化管理器数据
		app.ddz_NetManager().SendPack(headName, sendPack, this.OnSuccessInitDBData.bind(this), this.OnFailInitDBData.bind(this));
	},
