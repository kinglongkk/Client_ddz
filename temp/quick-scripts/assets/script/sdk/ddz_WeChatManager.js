(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/sdk/ddz_WeChatManager.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddzjda2a-f66e-49f7-92e0-6db533ae1fb6', 'ddz_WeChatManager', __filename);
// script/sdk/ddz_WeChatManager.js
...
var ddz_WeChatManager = app.BaseClass.extend({
	...
	OnWeChatError: function OnWeChatError(result) {
		...
		app.ddz_SysNotifyManager().ShowSysMsg("CodeErrorMsg", ["公众号签名初始化失败"]);
	},
	...
	OnPayResult: function OnPayResult(resultInfo) {
		...
		if (resultInfo["errMsg"] == "chooseWXPay:ok") {
			...
			console.log("支付失败");
			app.ddz_SysNotifyManager().ShowSysMsg("CodeErrorMsg", ["微信公众号支付失败:" + JSON.stringify(resultInfo)]);
		}
	},
	...
	WeChatShare: function WeChatShare(playgame) {
		...
		if (type == 'number') {
			playgame = app.ddz_ShareDefine().GametTypeID2PinYin[playgame];
		}
		var WeChatShare = new Array();
		var gameId = app.ddz_ShareDefine().GametTypeNameDict[playgame.toUpperCase()];
		var gamename = app.ddz_ShareDefine().GametTypeID2Name[gameId];
		var special = '';
		if (playgame) {
...
var g_ddz_WeChatManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function () {
	if (!g_ddz_WeChatManager) {
		g_ddz_WeChatManager = new ddz_WeChatManager();
	}
	return g_ddz_WeChatManager;
};
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_WeChatManager.js.map
