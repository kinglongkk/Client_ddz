(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/game/DDZ/room/ddz_PokerCard.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddz1b6b2-11f3-4b8b-b990-b44a94827188', 'ddz_PokerCard', __filename);
// script/game/DDZ/room/ddz_PokerCard.js
...
var ddz_PokerCard = app.BaseClass.extend({
    ...
    RefreshIs3DShow: function RefreshIs3DShow() {
        this.is3DShow = app.LocalDataManager().GetConfigProperty("SysSetting", app.subGameName + "_is3DShow");
    },
    ...
    GetPokeCardBack: function GetPokeCardBack() {
        //不同扑克牌选择不同list
        var curPokerList = this.pokerList;
        if (this.is3DShow == 0) {
            curPokerList = this.newPokerList;
        }
        for (var i = 0; i < curPokerList.length; i++) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_PokerCard.js.map
