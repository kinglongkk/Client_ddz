(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/game/DDZ/ui/UIDDZ_Result.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddzfe8c3-c5f5-4646-97c3-8193677fdeee', 'UIDDZ_Result', __filename);
// script/game/DDZ/ui/UIDDZ_Result.js
...
cc.Class({
    ...
    ShowResultNormal: function ShowResultNormal(allPlayer, setEnd, isReconnect) {
        ...
        for (var i = 0; i < playerList.length; i++) {
            ...
            if (isReconnect) {
                if (typeof setEnd.posInfo[i].sportsPoint != "undefined") {
                    if (setEnd.posInfo[i].sportsPoint > 0) {
                        playerNode.getChildByName("lb_sportsPoint").getComponent(cc.Label).string = "比赛分：+" + setEnd.posInfo[i].sportsPoint;
                    } else {
                        playerNode.getChildByName("lb_sportsPoint").getComponent(cc.Label).string = "比赛分：" + setEnd.posInfo[i].sportsPoint;
                    }
                }
            ...
            var head = playerNode.getChildByName("user_info").getChildByName("mask").getChildByName("head_img").getComponent(app.subGameName + "_WeChatHeadImage");
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UIDDZ_Result.js.map
