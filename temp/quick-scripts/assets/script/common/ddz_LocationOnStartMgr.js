(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/common/ddz_LocationOnStartMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddze8781-aa71-4b49-8660-e3b09a2f9c42', 'ddz_LocationOnStartMgr', __filename);
// script/common/ddz_LocationOnStartMgr.js
...
var ddz_LocationOnStartMgr = app.BaseClass.extend({
    ...
    OnGetLocation: function OnGetLocation() {
        if (!cc.sys.isNative) {
            ...
            //手机调用gprs调用上去
            var value = app.ddz_NativeManager().CallToNative("GetLocation", []);
        }
    },
...
var g_ddz_LocationOnStartMgr = null;
/**
...
*/
exports.GetModel = function () {
    if (!g_ddz_LocationOnStartMgr) {
        g_ddz_LocationOnStartMgr = new ddz_LocationOnStartMgr();
    }
    return g_ddz_LocationOnStartMgr;
};
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_LocationOnStartMgr.js.map
