(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/common/ddz_ShareDefine.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddz1a972-81b4-449b-9387-7becdf8675d5', 'ddz_ShareDefine', __filename);
// script/common/ddz_ShareDefine.js
...
var Room = function Room() {
	...
	//斗地主打牌阶段状态
	this.DDZSetState_OpenCard = 0; //明牌阶段
	this.DDZSetState_FaPai = 1; //发牌阶段
	this.DDZSetState_Hog = 2; //抢地主阶段
	this.DDZSetState_AddDouble = 3; //加倍阶段
	this.DDZSetState_Playing = 4; //打牌阶段
	this.DDZSetState_End = 5; //打牌结束阶段
	this.DDZSetStateStringDict = {};
	this.DDZSetStateStringDict["OpenCard"] = this.DDZSetState_OpenCard;
...
//-----基础---
Color.apply(ddz_ShareDefine, []);
Common.apply(ddz_ShareDefine, []);
GM.apply(ddz_ShareDefine, []);
Order.apply(ddz_ShareDefine, []);
Code.apply(ddz_ShareDefine, []);
Timer.apply(ddz_ShareDefine, []);
Chat.apply(ddz_ShareDefine, []);
Model.apply(ddz_ShareDefine, []);
Form.apply(ddz_ShareDefine, []);
Hero.apply(ddz_ShareDefine, []);
Effect.apply(ddz_ShareDefine, []);
SDK.apply(ddz_ShareDefine, []);
Mail.apply(ddz_ShareDefine, []);
Game.apply(ddz_ShareDefine, []);
//-----项目---
Rank.apply(ddz_ShareDefine, []);
Room.apply(ddz_ShareDefine, []);
MaJiang.apply(ddz_ShareDefine, []);
/**
 * 绑定模块外部方法
 */
exports.GetModel = function () {
	return ddz_ShareDefine;
};
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_ShareDefine.js.map
