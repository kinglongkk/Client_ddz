(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/common/ddz_EffectManager.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddz1a384-12fe-4187-a067-d480fbbdee21', 'ddz_EffectManager', __filename);
// script/common/ddz_EffectManager.js
...
var ddz_EffectManager = app.BaseClass.extend({
    ...
    LoadPrefab: function LoadPrefab(prefabPath) {
        ...
        return app.ddz_ControlManager().CreateLoadPromise(prefabPath).then(function (prefab) {
...
var g_ddz_EffectManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function () {
    if (!g_ddz_EffectManager) {
        g_ddz_EffectManager = new ddz_EffectManager();
    }
    return g_ddz_EffectManager;
};
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_EffectManager.js.map
