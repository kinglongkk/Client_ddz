(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/common/ddz_AudioManager.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddze0b43-70e8-411f-bffe-f22c44eeb96c', 'ddz_AudioManager', __filename);
// script/common/ddz_AudioManager.js
...
var ddz_AudioManager = app.BaseClass.extend({
    ...
    startRecord: function startRecord() {
        ...
        var value = app.ddz_NativeManager().CallToNative("startRecord", argList);
    },

    //停止录音
    stopRecord: function stopRecord() {
        app.ddz_FormManager().CloseForm(app.subGameName + "_UIAudio");
        var value = app.ddz_NativeManager().CallToNative("stopRecord", []);
    },
    ...
    downLoadRecordFile: function downLoadRecordFile(serverURL, LocalURL) {
        var downLoadMgr = app.ddz_DownLoadMgr();
    ...
    playAudio: function playAudio(filename, pos) {
        ...
        var value = app.ddz_NativeManager().CallToNative("playerRecord", argList);
    ...
    stopPlayAudio: function stopPlayAudio() {
        this.setHeadInfo(false);
        var value = app.ddz_NativeManager().CallToNative("stopPlayerRecord", []);
    },
    ...
    getFileName: function getFileName() {
        ...
        var AccountID = app.ddz_HeroAccountManager().GetAccountProperty("AccountID");
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_AudioManager.js.map
