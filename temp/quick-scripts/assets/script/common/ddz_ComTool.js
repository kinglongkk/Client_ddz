(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/common/ddz_ComTool.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddz2ab80-5498-4c75-a2a5-1463e854654d', 'ddz_ComTool', __filename);
// script/common/ddz_ComTool.js
...
var ddz_ComTool = app.BaseClass.extend({
    ...
    //替换指定位置的字符串
    ReplacePosToStr: function ReplacePosToStr(text, start, stop, replacetext) {
...
exports.GetModel = function () {
    if (!g_ddz_ComTool) {
        g_ddz_ComTool = new ddz_ComTool();
    }
    return g_ddz_ComTool;
};
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_ComTool.js.map
