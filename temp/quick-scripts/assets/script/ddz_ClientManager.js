(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/ddz_ClientManager.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddzd06fe-e8ef-4f86-bea8-0ef9e5f085c1', 'ddz_ClientManager', __filename);
// script/ddz_ClientManager.js
...
var ddz_ClientManager = cc.Class({
	...
	SetGameType: function SetGameType(typeStr) {
		if (app.subGameName == typeStr) this.gameType = 40;else this.gameType = -1;
	},
	//4:登录获取玩家当前参与的房间ID
	...
	OnPack_GetGameStatus: function OnPack_GetGameStatus(serverPack) {
		...
		if (isPlayingGame) {
			...
			//如果已经在登录场景则不切换
			if (app.subGameName + 'MainScene' != sceneType) this.ExitGame();
		}
	},
  ...
  */
	...
	RegisterHideShowEvent: function RegisterHideShowEvent() {
	...
	UnRegisterHideShowEvent: function UnRegisterHideShowEvent() {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_ClientManager.js.map
