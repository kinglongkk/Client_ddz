(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/net/ddz_NetWork.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddzj765a-0b0c-45ab-8927-6e107b36920e', 'ddz_NetWork', __filename);
// script/net/ddz_NetWork.js
...
var ddz_NetWork = app.BaseClass.extend({
	...
	IsDevelopment: function IsDevelopment() {
		return app.ddz_ShareDefine().IsDevelopment;
	},
  ...
  this.url = ['ws://',gameServerIP, ':', gameServerPort].join("");*/
	...
	ReConnectSuccess: function ReConnectSuccess() {
		if (app[app.subGameName + "Client"].isInGame() == false) {
			console.log("不在游戏内，ReConnectSuccess");
			return;
		}
		this.isReconnecting = false;
		//在发送挤压封包
...
exports.GetModel = function () {
	if (!g_ddz_NetWork) {
		g_ddz_NetWork = new ddz_NetWork();
	}
	return g_ddz_NetWork;
};
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_NetWork.js.map
