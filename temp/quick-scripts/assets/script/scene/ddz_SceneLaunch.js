(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/scene/ddz_SceneLaunch.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddze6854-95fc-41f4-be5c-fbe7094775a2', 'ddz_SceneLaunch', __filename);
// script/scene/ddz_SceneLaunch.js
...
cc.Class({
    ...
    LoadFirstConfig: function LoadFirstConfig() {
        if (cc.sys.isNative) {
            ...
            var that = this;
            this.Client.ddz_ControlManager.CreateLoadPromise("firstConfig").then(function (textData) {
    ...
    OnLoadTable: function OnLoadTable() {
        ...
        var _loop = function _loop(index) {
            ...
            _this.Client.ddz_ControlManager.CreateLoadPromise(tablePath, cc.RawAsset).then(function (textData) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_SceneLaunch.js.map
