...
var ddz_FormManager = app.BaseClass.extend({
    ...
    CreateForm:function(formPath){
        ...
        let that = this;
        return app.ddz_ControlManager().CreateLoadPromise(formPath)
    ...
    LoadSceneDefaultForm:function(sceneName){
        ...
        let NoAddScene=['clubScene','fightScene','launchScene','loginScene','ddzMainScene']; //四个基础场景不用添加uimore，uimark
        let BaseForm=[];
